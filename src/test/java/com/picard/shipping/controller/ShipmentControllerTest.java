...
class ShipmentControllerTest {
    ...
    @Test
    void createShipmentForOrderReturns201() throws Exception {
    ...
    @Test
    void getShipmentNotFoundReturns404() throws Exception {
    ...
    @Test
    void searchReturnsShipmentList() throws Exception {
    ...
    @Test
    void packReturns200() throws Exception {
        UUID id = UUID.randomUUID();
    ...
    @Test
    void labelPackageValidRequestReturns200() throws Exception {
